...
import { ScreeningRulesLoader } from './screening-rules-loader';
      ...
      {isLoading ? (
        ...
        <div className="grid-2 grid-cols-[1.4fr_1fr]">
          <div className="card">
            ...
            <div className="card-body grid grid-cols-2 gap-x-4 gap-y-2">
            ...
            <div className="card">
              ...
              <div className="card-body">
                <div className="hint mb-3.5">
                  ...
                  business day&apos;s ECB reference rate. Leave Max empty to
                  apply no upper limit.
                </div>
